...
<body>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="learnerlogin.php">Learner</a>
        </li>
       <li class="nav-item">
          <a class="nav-link" href="instructorlogin.php">Instructor</a>
        </li>
        <li class="nav-item">
        ...
        <form class="form-inline my-2 my-lg-0">
	        ...
	        <button class="btn btn-outline-primary my-2 my-sm-0" type="submit" style="background-color: #000000">Search</button>
        </form>
    </div>
</nav>
